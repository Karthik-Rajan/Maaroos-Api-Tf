...
var handler = function (event, context) { return __awaiter(void 0, void 0, void 0, function () {
    var sub, vId, body, _a, rating, comment;
    var _b, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                body = event.body;
                _a = JSON.parse(body), rating = _a.rating, comment = _a.comment;
                return [4 /*yield*/, Review_1["default"].findOrCreate({
                        where: {
                            user_uuid: sub,
                            vendor_id: vId,
                            rating: rating,
            ...
            case 1:
                _d.sent();
                return [2 /*return*/, (0, helper_1.response)(200, {})];
        }
    });
}); };
